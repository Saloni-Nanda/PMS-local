...
import { ChevronLeft, ChevronRight, Luggage, UserRound, UsersRound } from "lucide-react";
                                    ...
                                    {room.prices.map((price, i) => (
                                        <td key={i} className="border px-6 py-6 text-center">
                                            <div className="flex flex-col items-center text-sm">
                                                ...
                                                {/* Luggage row with proper top margin */}
                                                <div className="flex items-center space-x-1 mt-6">
                                                    <Luggage className="h-4 w-4 text-red-500" />
                                                    <span>-/-</span>
                                                </div>
                                            </div>
                                        </td>
