...
interface Props {
  ...
  initialStatus: "Vacant" | "Occupied";
  initialCondition: "Clean" | "Dirty" | "Cleaning in Progress";
  onSave: (
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-black/50 z-50">
      <div className="bg-white rounded-xl shadow-lg w-full max-w-md p-6">
        <h3 className="text-xl font-bold mb-4 text-center">Modification of Room Status</h3>
